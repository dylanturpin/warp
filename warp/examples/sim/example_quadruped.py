...
def _featherstone_factory(model, **kwargs):
...
class Example:
    def __init__(
        ...
        offsets = warp.examples.compute_env_offsets(self.num_envs)
    ...
    def get_state(self) -> dict:
        """Return key tensors as NumPy arrays."""
